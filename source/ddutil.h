...
public:
	HFONT CreateHFONT(const char *facename, int size, long lfweight, bool bItalic,
...
public:
    ...
    HRESULT DrawText( HFONT hFont, LPCTSTR, DWORD dwOriginX, DWORD dwOriginY,
